...
class Processor:
    ...
    def process4jiyi(self, jiyi_path):
        files = self._scan_data_dir4zeroeggs(jiyi_path)  # {file_name: {dir, speaker_id}}
        # breakpoint()
        num_files = len(files)
    ...
    # def _scan_data_dir4jiyi(self, files_path):
    #     """ Scan Data Dir & Get File Name, Dir, and Speaker ID. """
    ...
    #         for n in f:
    #             if os.path.splitext(n)[1] == ".bvh":
    #                 files[os.path.join(r, os.path.splitext(n)[0])] = {"dir": r
    #                                                                 # "speaker_id": int(os.path.basename(r))
    #                                                                 }  
    #     return files    
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='Data/JIYI_Data')
    parser.add_argument('--save_dir', type=str, default='Data/JIYI_processed')
    ...
    # jiyi_path = os.path.join(args.data_dir, 'zeroeggs')
    # processor.process4mocap(sg_path)
    processor.process4jiyi(args.data_dir)
