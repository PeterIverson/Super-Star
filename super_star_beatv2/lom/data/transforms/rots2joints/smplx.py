...
from lom.utils.joints import smplh_to_mmm_scaling_factor, smplh2mmm_indexes, get_root_idx
from lom.utils.easyconvert import rep_to_rep
...
def smplx_to(jointstype, data, trans):
    ...
    if "mmm" in jointstype:
        ...
        from lom.utils.joints import smplh2smplnh_indexes
